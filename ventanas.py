...
#-----------------------------------------------------------------------------
'''
Este codigo se encarga de mejorar la ORGANIZACION de los estilos del codigo anterior
...
#SE TRAEN LOS COLORES CLAVE Y BONITOS PARA EL FONDO SIEMPRE EN LA PARTE SUPERIOR:
#La razon es para facilitar el orden de los estilos y en caso de que se quieran cambiar, sea mas facil
COLOR_MARCO_PRINCIPAL = "black"
COLOR_FONDO = "#99FFFF"
COLOR_FONDO_TITULO = "#FFFF66"
FONDO_BOTON = "#80FF00"
COLOR_LETRA_SALUDO = "#0000FF"
...
class APP(tk.Tk):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.style.configure("LabelTitulo_1.TLabel",font = ("Times New Roman",16, "bold"), bordercolor = "black", borderwidth = 10,relief = "solid",background = COLOR_FONDO_TITULO, padding = 10)
        
        #TERCER ESTILO (PARA SALUDAR AL USUARIO)
        self.style.configure("LabelSaludar.TLabel",font = ("Times New Roman",12, "bold"), foreground = COLOR_LETRA_SALUDO,background = COLOR_FONDO, padding = 5)
        ...
        self.style.configure( "BotonPersonalizado.TButton", font = ("Times New Roman",12, "bold"), background = FONDO_BOTON, padding = 2 )
        self.style.map( "BotonPersonalizado.TButton",
                        foreground = [("pressed", "red"),("active","blue")],
                        background = [("pressed", "!disabled",FONDO_BOTON),("active", FONDO_BOTON)]
         )
...
class Frame_1(tk.Frame):
    ...
    def __init__(self, container, controller,*args, **kwargs):
        ...
        B_2.grid(row = 3, column = 0,pady = 10)
